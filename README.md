...
- **주요 컴포넌트**: COCL 프로젝트는 크게 3가지의 주요 컴포넌트로 구성됩니다. 첫 번째는 대학 캠퍼스의 재생에너지(전기) 발전량과, 캠퍼스의 전기 소모량을 강의실, 개별 PC 단위로 측정하기 위한 '캠퍼스의 탄소발자국 측정' 컴포넌트, 전력 소비 최적화를 위한 '최적화 모듈' 컴포넌트와 시각화 및 모니터링을 위한 '모니터링 대시보드' 컴포넌트로 구성됩니다. 
